...
func (sdc *SDC) ConvertToItemPartner(num int) *requests.ItemPartner {
	dataSalesOrder := sdc.SalesOrder
	dataSalesOrderItem := sdc.SalesOrder.SalesOrderItem[num]
	data := sdc.SalesOrder.SalesOrderItem[num].ItemPartner
...
func (sdc *SDC) ConvertToItemPricingElement(num int) *requests.ItemPricingElement {
	dataSalesOrder := sdc.SalesOrder
	dataSalesOrderItem := sdc.SalesOrder.SalesOrderItem[num]
	data := sdc.SalesOrder.SalesOrderItem[num].ItemPricingElement
...
func (sdc *SDC) ConvertToItemScheduleLine(num int) *requests.ItemScheduleLine {
	dataSalesOrder := sdc.SalesOrder
	dataSalesOrderItem := sdc.SalesOrder.SalesOrderItem[num]
	data := sdc.SalesOrder.SalesOrderItem[num].ItemScheduleLine
